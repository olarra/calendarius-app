...
/* Local Dependencies */
import { addMeeting, fetchAgenda, removeMeeting, updateMeeting } from "../redux/agenda/actions";
...
const mapActionsToDispatch = dispatch => ({
  ...
  removeMeeting : (iAgenda,iMeeting) => dispatch(removeMeeting(iAgenda,iMeeting)),
